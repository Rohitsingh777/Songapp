...
export default function Song({ route }) {
  ...
  const Getfunction = async () => {
    try {
      ...
      const gen = List.filter(
        (element) => element.primaryGenreName == thistrack[0]?.primaryGenreName
      );
      setgenerlist(gen);
    ...
    >
      <View style={styles.trackview}>
        <View style={styles.Imageview}>
          <TouchableOpacity
            onPress={() => {
              Linking.openURL(`${Track?.trackViewUrl}`);
            }}
          >
            <Image
              style={styles.Image}
        ...
        <View style={styles.desc}>
          ...
          <View style={styles.artdesc}>
            ...
            >
              ...
              >
                <Text style={styles.explicit}>{Track?.trackExplicitness}</Text>
              </View>
            </View>
